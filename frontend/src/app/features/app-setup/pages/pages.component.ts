...
const ALL_ICONS: string[] = [
  ...
  'abstract-7','abstract-8','abstract-9','abstract-10','abstract-11','abstract-12','abstract-13',
  'abstract-14','abstract-15','abstract-16','abstract-17','abstract-18','abstract-19','abstract-20',
  'abstract-21','abstract-22','abstract-23','abstract-24','abstract-25','abstract-26','abstract-27',
  'abstract-28','abstract-29','abstract-30','abstract-31','abstract-32','abstract-33','abstract-34',
  'abstract-35','abstract-36','abstract-37','abstract-38','abstract-39','abstract-40','abstract-41',
  'abstract-42','abstract-43','abstract-44','abstract-45','abstract-46','abstract-47','abstract-48',
  'abstract-49','add-files','add-folder','add-item','add-notepad','address-book','airplane',
...
export class PagesComponent {
  ...
  currentIcon(slot: IconSlot): string {
    return this.iconConfig.icon(slot.key, slot.defaultIcon);
  }
  ...
  resetSlot(slot: IconSlot): void {
    this.iconConfig.resetIcon(slot.key);
  }

  resetPage(): void {
    const page = this.selectedPage();
    if (!page) return;
    page.slots.forEach(s => this.iconConfig.resetIcon(s.key));
  }

  resetAll(): void {
    this.iconConfig.resetAll();
  }

  overridesCount(page: AppPage): number {
    return page.slots.filter(s => this.iconConfig.hasOverride(s.key)).length;
  }
}
