...
public class FavoriteProductItemsController : ControllerBase
{
    private readonly IFavoriteProductItemRepository _repo;

    public FavoriteProductItemsController(IFavoriteProductItemRepository repo) => _repo = repo;
    ...
    public async Task<IActionResult> Add(long productItemId)
    {
        ...
        await _repo.CreateAsync(new FavoriteProductItem
        {
